...
public class test02 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet test02</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet test02 at " + request.getContextPath() + "</h1>");
            out.println("<h1>ISBN10: " + isValidISBN10("817525766-0") + "</h1>");
            out.println("<h1>ISBN13: " + isValidISBN13("978-0321349804") + "</h1>");
